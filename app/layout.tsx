...
export const metadata: Metadata = {
  ...
  authors: [{ name: "Xuan" }],
  metadataBase: new URL("https://blog.aozaki.cc"),
  openGraph: {
...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      <body
        className={`${inter.variable} ${ioskeleyMono.variable} font-sans bg-back-light tracking-custom antialiased selection:bg-selected ss:min-h-dynamic dark:bg-back-dark`}
      >
