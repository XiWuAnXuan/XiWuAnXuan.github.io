/**
 * Input: @/.velite, #components/pagination-nav, #components/post-list, lib/pagination.mjs
 * Output: metadata, PostsPage (default)
 * Pos: 路由层-文章列表第1页，分页入口
 *
 * 本注释在文件修改时自动更新
 */
...
import { getPaginatedItems, getTotalPages, POSTS_PER_PAGE } from '../../lib/pagination.mjs'
